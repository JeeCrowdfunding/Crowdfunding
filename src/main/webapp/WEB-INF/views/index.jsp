                        ...
                        <div class="accordion" id="accordion2">
                          <div class="accordion-group">
                            ...
                            <div style="height: 0px;" id="collapse_1" class="accordion-body collapse" >
                              <div class="accordion-inner" ng-controller="registerUserCtrl">
                                <div class="row-fluid border_proj duration" >
                                <div class="span10 ">
                                    <div class="column_project">
                                        <h4 class="text-center">Personal Info:</h4>
                                        <div action="inscription"  class="form-search" >
                                            <input ng-model="name" type="text" class="inputp search-query span12" placeholder="Name">
                                            <input ng-model="surname" type="text" class="inputp search-query span12" placeholder="Surname">
                                            <input ng-model="email" type="text" class="inputp search-query span12" placeholder="Email">
                                            <input ng-model="phone" type="text" class="inputp search-query span12" placeholder="Phone">
                                            <input ng-model="pwd" type="password" class="inputp search-query span12" placeholder="Password">
                                            <input ng-model="rpwd" type="password" class="inputp search-query span12" placeholder="Repeat Password">
                                        </div>
                                    </div>
                                </div>
                                </div>
